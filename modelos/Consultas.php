<?php 
	...
	Class Consultas{
		...
		$sql="SELECT IFNULL (SUM(total_compra),0) as total_compra FROM ingreso WHERE DATE(fecha_hora)=curdate() AND estado <> 'Anulado'";
			return ejecutarConsulta($sql);
		}
		...
		public function ventassultimos_12meses(){
